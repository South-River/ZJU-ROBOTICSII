...
{	
    ...
    odom_pub = n.advertise<std_msgs::Float64MultiArray>("u", 10);
}
...
void icp::process(sensor_msgs::LaserScan input)
{
    ...
    //cout<<"Transform_acc:"<<endl<<Transform_acc<<endl;
    tar_pc = this->rosmsgToEigen(input);
...
{	
    ...
    double dyaw = atan2(T(1,0), T(0,0));
    msg.data.push_back(T(0,2));
    msg.data.push_back(T(1,2));
    msg.data.push_back(dyaw);
